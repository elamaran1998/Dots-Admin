import { Box, Button, Divider, FormControl, Grid, Input, Select, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Typography } from '@mui/material'
...
const Appointment = () => {
    ...
    // const [,setUsersType] = React.useState(0);
              ...
              {data.length === 0 ? (
                ...
                data.map((item) => (
                  ...
                  >
                    ...
                    <TableCell sx={{pl:'50px',border:'1px solid #ebebeb', borderCollapse:'collapse'}}>Text</TableCell>
                    <TableCell sx={{pl:'50px',border:'1px solid #ebebeb', borderCollapse:'collapse'}}>Text</TableCell>
                    <TableCell sx={{pl:'50px',border:'1px solid #ebebeb', borderCollapse:'collapse'}}>Text</TableCell>
                  </TableRow>
                ))
